...
export function isOptionalFile(name) {
    return /\boptional\b/i.test(name);
}
export function isSelectiveFile(name) {
...
export function extractGameTitle(firstFileName) {
    try {
...
export function extractLinks(plaintext) {
